...
class FreeGamesScreenCurrent extends StatefulWidget {
  @override
  _FreeGamesScreenCurrentState createState() => _FreeGamesScreenCurrentState();
}

class _FreeGamesScreenCurrentState extends State<FreeGamesScreenCurrent> {
  ...
  Widget build(BuildContext context) {
    var currentDate = "${selectedDate.toLocal()}".split(' ')[0];
    return Scaffold(

...
class VipPrevious extends StatefulWidget {
  @override
  _VipPreviousState createState() => _VipPreviousState();
}

class _VipPreviousState extends State<VipPrevious> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        //           MaterialPageRoute(builder: (context) => UploadPredictions())),
        //     )
        //     // AnimatedSwitcher(
        //     //   duration: Duration(seconds: 2),
        //     //   child: (isVisible1 && isVisible2)
        //     //       ? IconButton(
        //     //           icon: Icon(Icons.add, color: Colors.white),
                ...
                if (snapshot.data != null) {
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      if (previousDate == snapshot.data[index]["GameDate"]) {
                        print(previousDate +
                            "    ==============>    " +

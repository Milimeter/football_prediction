...
class VipCurrent extends StatefulWidget {
  @override
  _VipCurrentState createState() => _VipCurrentState();
}

class _VipCurrentState extends State<VipCurrent> { 
                ...
                if (snapshot.data != null) {
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      if (currentDate == snapshot.data[index]["GameDate"]) {
                        print(currentDate +
                            "    ==============>    " +
